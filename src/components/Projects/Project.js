        ...
        <div id="projects">
            <div className={styles.projects}>
                ...
                <section className={styles.projectHeader}>
                    ...
                    <div>
                       I enjoy exploring modern web technologies and building interactive applications. Most of my projects are developed with React and deployed seamlessly to the web using GitHub Pages.
                    </div>
                </section>
            </div>
            <ProgrammingSkills />
